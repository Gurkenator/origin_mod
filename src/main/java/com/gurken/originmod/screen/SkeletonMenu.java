...
public class SkeletonMenu extends AbstractContainerMenu {
    private final SkeletonBlockEntity blockEntity;
    private final Level level;

    public SkeletonMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()));
    }

    public SkeletonMenu(int pContainerId, Inventory inv, BlockEntity entity) {
        super(Registration.SKELETON_MENU.get(), pContainerId);
        checkContainerSize(inv, 15);
        blockEntity = ((SkeletonBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, Registration.SKELETON_BLOCK.get());
    }
